...
class TestHierarchicalConfigurationRoot(unittest.TestCase):
    ...
    def test_cisco_style_text(self):
        hier = HierarchicalConfigurationRoot(self.host_a, self.os)
    ...
    def test_dump_and_load_from_dump_and_compare(self):
        hier_pre_dump = HierarchicalConfigurationRoot(self.host_a, self.os)
        ...
        hier_post_dump = HierarchicalConfigurationRoot(self.host_a, self.os)
    ...
    def test_config_to_get_to(self):
        running_config_hier = HierarchicalConfigurationRoot(self.host_a, self.os)
        running_config_hier.add_child('interface vlan2')
        compiled_config_hier = HierarchicalConfigurationRoot(self.host_a, self.os)
