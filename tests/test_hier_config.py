...
class TestHConfigRoot(unittest.TestCase):
    ...
    def test_cisco_style_text(self):
        hier = HConfigRoot(self.host_a, self.os, self.options)
    ...
    def test_dump_and_load_from_dump_and_compare(self):
        hier_pre_dump = HConfigRoot(self.host_a, self.os, self.options)
        ...
        hier_post_dump = HConfigRoot(self.host_a, self.os, self.options)
    ...
    def test_config_to_get_to(self):
        running_config_hier = HConfigRoot(self.host_a, self.os, self.options)
        running_config_hier.add_child('interface vlan2')
        compiled_config_hier = HConfigRoot(self.host_a, self.os, self.options)
