...
>>> import yaml
>>>
>>> options = yaml.load(open('./tests/fixtures/options_junos.yml'), Loader=yaml.SafeLoader)
...
delete interfaces irb unit 2 disable
delete interfaces irb unit 3 family inet address 10.0.4.1/16
delete interfaces irb unit 3 description "switch_mgmt_10.0.4.0/24"
...
>>> for line in host.running_config.children:
...     print(line.text)
... 
