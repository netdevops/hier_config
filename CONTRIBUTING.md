...
```bash
pytest tests/test_driver_cisco_ios.py
```
...
Read the [Architecture Overview](https://hier-config.readthedocs.io/en/latest/dev/architecture/) before making structural changes.
